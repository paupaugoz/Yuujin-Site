...
import { Temaki, Appetizer, Makimono, Sushi, Sashimi, RiceTopping, Rice, Yakimono, Agemono,
         Teppanyaki, HotNoodle, ColdNoodle, Salad, HotPot, Dessert, Beverages} from './MenuItems/Index';
